...
public class AllyTrackingCircleObstacle extends TrackingCircleObstacle {
	private int maxCollisions = 1;
	private int MAX_SPEED = 5;
	
	public AllyTrackingCircleObstacle(int diameter, int x, int y, int speed, Direction dir, GameController controller, int bounceCount) {
		super(diameter, x, y, speed, dir, controller);
